...
- [ish](https://github.com/briones-agent/ish): Isolated approach using local Swift Package — Objective-C host with a C/asm core ([recording](https://github.com/expo/expo-brownfield-examples/releases/download/captures-05-ish/recording.mp4))
