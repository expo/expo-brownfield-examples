...
- [NewPipe](https://github.com/briones-agent/NewPipe): Isolated approach using a shared fused AAR (SDK 57 canary) — Kotlin/Java media client consuming `dev.expo.brownfield:expobrownfield-fused-release:1.0.1` from the remote Maven repository in [briones-agent/packages](https://github.com/briones-agent/packages), with no repo-local Expo app or React Native toolchain; originally the first user of `expo-brownfield build:android --fused` ([PR #45878](https://github.com/expo/expo/pull/45878)) ([recording](https://raw.githubusercontent.com/expo/expo-brownfield-examples/media/02-newpipe/newpipe-expo.mp4))
